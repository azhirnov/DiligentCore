if(PLATFORM_WIN32 OR PLATFORM_UNIVERSAL_WINDOWS)
    ...
    function(copy_required_dlls TARGET_NAME)
        if(D3D11_SUPPORTED)
            ...
            target_sources(${TARGET_NAME} PRIVATE "${Diligent-GraphicsEngineD3D11-trigger}")
            source_group("src\\_gen_" FILES "${Diligent-GraphicsEngineD3D11-trigger}")
            set_property(SOURCE "${Diligent-GraphicsEngineD3D11-trigger}" PROPERTY GENERATED 1)
        endif()
        if(D3D12_SUPPORTED)
            list(APPEND ENGINE_DLLS Diligent-GraphicsEngineD3D12-shared)
            target_sources(${TARGET_NAME} PRIVATE "${Diligent-GraphicsEngineD3D12-trigger}")
            source_group("src\\_gen_" FILES "${Diligent-GraphicsEngineD3D12-trigger}")
            set_property(SOURCE "${Diligent-GraphicsEngineD3D12-trigger}" PROPERTY GENERATED 1)
        endif()
        if(GL_SUPPORTED)
            list(APPEND ENGINE_DLLS Diligent-GraphicsEngineOpenGL-shared)
            target_sources(${TARGET_NAME} PRIVATE "${Diligent-GraphicsEngineOpenGL-trigger}")
            source_group("src\\_gen_" FILES "${Diligent-GraphicsEngineOpenGL-trigger}")
            set_property(SOURCE "${Diligent-GraphicsEngineOpenGL-trigger}" PROPERTY GENERATED 1)
        endif()
        if(VULKAN_SUPPORTED)
            list(APPEND ENGINE_DLLS Diligent-GraphicsEngineVk-shared)
            target_sources(${TARGET_NAME} PRIVATE "${Diligent-GraphicsEngineVk-trigger}")
            source_group("src\\_gen_" FILES "${Diligent-GraphicsEngineVk-trigger}")
            set_property(SOURCE "${Diligent-GraphicsEngineVk-trigger}" PROPERTY GENERATED 1)
        endif()
        if(METAL_SUPPORTED)
            list(APPEND ENGINE_DLLS Diligent-GraphicsEngineMetal-shared)
            target_sources(${TARGET_NAME} PRIVATE "${Diligent-GraphicsEngineMetal-trigger}")
            source_group("src\\_gen_" FILES "${Diligent-GraphicsEngineMetal-trigger}")
            set_property(SOURCE "${Diligent-GraphicsEngineMetal-trigger}" PROPERTY GENERATED 1)
        endif()
